...
- Any truncated comparison axis must state its visible range, show an axis-break mark, and disclose the
  truncation beside the scenario methodology. Bars carry category through color and proportion; the
  headline callout carries the claimed illustrative delta.
- The economics Hero uses an obsidian / graphite / steel-blue tonal range. Avoid a white-versus-saturated-
  blue column pairing; the brand blue is reserved for restrained edges and routing accents, not large fills.

...
- Product capture: `assets/agent-farm-brand/agent-farm-ui-scrubbed.png`
- Capture source: the current local native UI artifact at
  `../test-artifacts/release-0.5.0.9-final.png`; task-history content is redacted in the website copy.
...
- Display tracking: tight, from `-0.055em` to `-0.02em`
...
- The routing visual explains architecture and does not estimate savings.
- The interactive flow is labeled as a browser simulation and makes no backend call.
